(function ($) {
    ...
    * Preloader 
    ...
    $(".recr-content").on('click', function () {
    ...
    // s-link active
    $('.single-post-active').on('mouseenter', function () {
        $(this).addClass('active').parent().siblings().find('.single-post-active').removeClass('active');
    })
